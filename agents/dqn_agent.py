...
class DeepQNetworkAgentv3:
    ...
    def __init__(self, model: torch.nn.Module, action_size: int, device: torch.device, agent_hyper_params: Dict,
        ...
        self.scheduler = optim.lr_scheduler.StepLR(optimizer=self.optimizer, step_size=500, gamma=0.5)
    ...
    def reward_update(self, reward: float, punish: bool = False) -> float:
        ...
        # Define a base factor: lower for rewards, higher for punishments
        base_factor = 1.4 if not punish else 1.8
