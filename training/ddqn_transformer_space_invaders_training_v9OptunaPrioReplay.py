...
class Hyperparameters(object):
    ...
    def get_params(trial):
        agent_hyper_params = {
            ...
            "epsilon_decay": trial.suggest_float("epsilon_decay", 0.005, 0.01, log=True),                   # factor by which epsilon gets reduced
            ...
            "learn_start": 50,                                                                              # number of episodes which have to be played before the training starts (10% of n_episodes)
...
# ################ train agent ########################
# #####################################################
ao = AgentOptimizerOptuna(agent=DeepQNetworkAgentPrioritized,
...
ao.train(n_trials=100, n_jobs=2, warmup_steps=50)
