...
class Hyperparameters(object):
    ...
    def get_params(trial):
        ...
        network_hyper_params = {
            ...
            "num_heads": trial.suggest_categorical("num_heads", [1, 2, 4]),                                 # number of attention heads in transformer layers
            "num_layers": trial.suggest_categorical("num_layers", [1, 2, 3]),                               # number of transformer encoding layers
            ...
            "conv_channels": [0, 0, 0, 4],                                                                  # convolutional channels for CNN picture extraction (if lean ccn True only first and last channel config is used)
