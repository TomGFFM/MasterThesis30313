...
class Hyperparameters(object):
    ...
    def get_params(trial):
        agent_hyper_params = {
            ...
            "max_steps_episode": 4000,                                                                      # maximum actions to be expected within an episode
        ...
        network_hyper_params = {
            "input_shape": (4, 80, 80),                                                                     # desired shape of state pictures
            "num_actions": env.action_space.n,                                                              # number of allowed actions in game
            "hidden_size": trial.suggest_categorical("hidden_size", [128, 256, 512, 1024]),                 # number of attention heads in transformer layers
            ...
            "conv_channels": [32, 48, 64, 80],                                                              # convolutional channels for CNN picture extraction
...
ao.train(n_trials=25, n_jobs=1, warmup_steps=150)
