...
from utils import FrameProcessor, AgentOptimizerv5
...
model_name = 'DDQAugmentedTransformerNNv8'

# Q-Network
policy_net = DDQAugmentedTransformerNNv2(**network_hyper_params).to(device)
target_net = DDQAugmentedTransformerNNv2(**network_hyper_params).to(device)
