...
agent_hyper_params = {
    ...
    "epsilon_decay": 0.0001,                # factor by which epsilon gets reduced
...
network_hyper_params = {
    "input_shape": (4, 96, 96),             # desired shape of state pictures
    ...
    "conv_channels": [64, 128, 256, 512],   # convolutional channels for CNN picture extraction
