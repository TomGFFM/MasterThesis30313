...
# custom
from utils import FrameProcessorDynamic, OptimizerSelector, LossFunctionSelector, LRSchedulerSelector
...
class AgentOptimizerOptunaNoisy:
    ...
    def objective(self, trial: Trial) -> float:
        ...
        for episode in range(1, agent_hyper_params['n_episodes'] + 1):
            ...
            # save all intermediate model checkpoints when mvg avg score > 0.3
            if mvg_avg_score >= 0.3:
