...
from utils import FrameProcessor, AgentOptimizerv3
...
agent_hyper_params = {
    ...
    "max_steps": 3000,                      # maximum actions to be expected within an episode
...
# init agent
agent = DeepQNetworkAgentv3(model=DDQAugmentedTransformerNN,
                            action_size=env.action_space.n,
                            device=device,
                            agent_hyper_params=agent_hyper_params,
                            network_hyper_params=network_hyper_params,
                            model_name='DDQAugmentedTransformerNNv6')

# #####################################################
# ################ train agent ########################
# #####################################################
ao = AgentOptimizerv3(agent=agent,
                      env=env,
