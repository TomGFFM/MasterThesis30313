...
trained_agent.load('/Users/thomas/Repositories/MasterThesis30313/output/models/20240716_DDQAugmentedTransformerNNv2_best_model_score.pth', map_location=device)
