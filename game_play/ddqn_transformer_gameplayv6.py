...
# import custom
from agents import DeepQNetworkAgentv3
...
agent_hyper_params = {
    ...
    "update_target": 250,                   # threshold to start the replay
...
# init agent
trained_agent = DeepQNetworkAgentv3(model=DDQAugmentedTransformerNN,
...
trained_agent.load('/Users/thomas/Repositories/MasterThesis30313/output/models/20240811_DDQAugmentedTransformerNNv5_best_model_episode_446_score_0.19446.pth', map_location=device)
